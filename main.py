...
#här har jag ändrat cpu och cuda
def main():
    ...
    #Jag vet inte vad dessa argument gör, men de måste köras varje gång med koden
    #Jag använder dessa nu men behöver nog ändra dessa sen för att det ska matcha med min data.



    #Jag har fortfarande cuda problem, men dessa behöver ändras efter att datan har ändrats
    ...
    #jag kommenterade bort denna i den originala protopnet
